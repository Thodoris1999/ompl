...
PyType_Slot simple_setup_slots[] = {
    { Py_tp_traverse, (void *) simple_setup_tp_traverse },
...
void ompl::binding::control::init_SimpleSetup(nb::module_ &m)
{
    nb::class_<oc::SimpleSetup>(m, "SimpleSetup", nb::type_slots(simple_setup_slots), nb::dynamic_attr())
        ...
        .def("getSpaceInformation",
             &oc::SimpleSetup::getSpaceInformation)
        ...
        // getStateSpace
        .def("getStateSpace",
             &oc::SimpleSetup::getStateSpace)
        
        // getControlSpace
        .def("getControlSpace",
             &oc::SimpleSetup::getControlSpace)
        
        // getStateValidityChecker
        .def("getStateValidityChecker",
             &oc::SimpleSetup::getStateValidityChecker)
        
        // getStatePropagator
        .def("getStatePropagator",
             &oc::SimpleSetup::getStatePropagator)
        
        // getGoal
        .def("getGoal",
             &oc::SimpleSetup::getGoal)
        
        // getPlanner
        .def("getPlanner",
             &oc::SimpleSetup::getPlanner)
        
        // getPlannerAllocator
        .def("getPlannerAllocator",
             &oc::SimpleSetup::getPlannerAllocator)
        
        // haveExactSolutionPath, haveSolutionPath
        .def("haveExactSolutionPath",
             &oc::SimpleSetup::haveExactSolutionPath)
        .def("haveSolutionPath",
             &oc::SimpleSetup::haveSolutionPath)
        
        // getSolutionPath (return by reference)
        .def("getSolutionPath",
             [](oc::SimpleSetup &self) -> oc::PathControl & {
        ...
        // getPlannerData
        .def("getPlannerData",
             [](oc::SimpleSetup &self, ob::PlannerData &pd) {
